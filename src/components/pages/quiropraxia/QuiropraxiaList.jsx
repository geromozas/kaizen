...
const QuiropraxiaList = ({ patients = [], setIsChange }) => {
  ...
  // Abrir modal de cancelación de sesiones
  ...
  // Registrar asistencia y pago de sesión
  const handleRegistrarAsistencia = async () => {
    ...
    const pagoFinal = {
      fecha: nuevoPago.fecha,
      hora: nuevoPago.hora,
      concepto: nuevoPago.concepto || "Sesión de Quiropraxia",
      metodo: nuevoPago.metodo,
      monto: monto,
      mes: mesPago,
      createdAt: Timestamp.fromDate(fechaPago),
    ...
    try {
      ...
      const patientRef = doc(db, "quiropraxia", patientSelected.id);
  ...
  // Obtener estado del paciente basado en sesiones
  ...
  return (
    <div style={{ marginTop: 20 }}>
      ...
      {/* Modal de cancelación de sesiones */}
      <Modal
